...
class GameState:
    def __init__(self, num_players=2, seed=None, rng=None, board=None,
        ...
        # part in equality.
        self._longest_road_key = None
        self._longest_road_lengths = None
    ...
    def clone(self, rng=None):
        ...
        **Pass ``rng=state.rng`` in search.** Snapshotting a Mersenne Twister copies 625
        ...
        other._longest_road_key = self._longest_road_key
        other._longest_road_lengths = self._longest_road_lengths
